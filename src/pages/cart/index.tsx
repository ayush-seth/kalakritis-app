...
export default function Cart() {
  ...
  return (
    <>
      {cartInfo ? (
        <div className="px-12 pt-[160px]">
          <Tabs.Root className="TabsRoot" defaultValue="tab2">
            <Tabs.List className="TabsList mb-[80px] flex justify-center gap-28">
              <Tabs.Trigger className="TabsTrigger" value="tab1">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#DEDDDA]">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
                  ...
                  <div className="text-xl font-semibold text-[#808080]">
                    Cart
                  </div>
                </div>
              </Tabs.Trigger>
            ...
            <div className="mx-auto flex max-w-[1300px]">
              ...
              <div className="basis-[400px] border-l border-slate-500 py-5 pl-10">
                <div className="apply_coupon_area mb-16">
                  ...
                  <form action="" className="flex gap-3">
                    ...
                    />
                    <button className="h-11 bg-[black] px-8 text-white">
                      APPLY
                    </button>
                  </form>
                </div>
        ...
        <div className="flex h-[600px] flex-col items-center justify-center pt-[160px]">
          <Image src={"/cart_empty.svg"} alt="" width={100} height={100} />
          <h3 className="my-4 text-2xl font-medium">
            Oops, your cart is empty !
          </h3>
          <Button variant="primary" className="mt-4 h-12 w-44">
            SHOP NOW
          </Button>
        </div>
      )}
